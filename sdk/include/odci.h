...
#define ODCI_EXTTABLE_OPEN_FLAGS_OLD_CA          0x00008000
                                              /* using decimal scaled binary */
#define ODCI_EXTTABLE_OPEN_FLAGS_DSB             0x00010000
                                     /* modified location by external modify */
#define ODCI_EXTTABLE_OPEN_FLAGS_MODLOC          0x00020000
                                        /* hybrid partitioned external table */
#define ODCI_EXTTABLE_OPEN_FLAGS_HYPT            0x00040000

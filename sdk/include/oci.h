...
/* 
   ...
   ssonawan    01/18/21 - Backport ssonawan_ci_28844656_19.0 from st_rdbms_19
   ssonawan    10/17/20 - Backport ssonawan_adg_redirect_perf_backport from
                          st_rdbms_19
   ssonawan    09/25/20 - backport ssonawan_adg_redirect_perf
   chenxma     07/15/20 - Backport SODA bugs from MAIN to 19DBRU
   kkverma     01/16/20 - Backport kkverma_bug-30342371 from main
   apfwkr      12/11/19 - Backport jstenois_bug-29792213 from main
   ...
   jstenois    05/30/19 - Bug 29792213: add NUMERIC_CHARACTERS clause
...
#define  OCI_ATTR_SODA_AS_OF_SCN                574
#define  OCI_ATTR_SODA_AS_OF_TSTAMP             575
#define  OCI_ATTR_SODA_FILTER                   576
#define  OCI_ATTR_SODA_SKIP                     577           
#define  OCI_ATTR_SODA_LIMIT                    578
#define  OCI_ATTR_SODA_LOCK                     579
...
#define OCI_ATTR_ORAACCESS_CONNALIAS            612

#define OCI_ATTR_RESERVED_613                   613
#define OCI_ATTR_SODA_METADATA_CACHE            624

/* More OCI SODA attributes */
#define OCI_ATTR_SODA_HINT                      627
...
/* OCISodaCollDrop specific modes */
#define OCI_SODA_COLL_DROP_PURGE                0x00010000
                           /* Purge the data table when dropping a collection */
#define OCI_SODA_COLL_DROP_MAPPED_TABLE         0x00020000
                     /* Drop the data table when dropping a mapped collection */

#define OCI_SODA_TRUNCATE_REUSE_STORAGE         0x00010000
                                   /* Retain space from the deleted documents */
...
/* OCI SODA DataGuide formats */
#define OCI_SODA_DG_FMT_HIERARCHICAL                1         /* Hierarchical */
#define OCI_SODA_DG_FMT_FLAT                        2                 /* Flat */

/* OCI SODA DataGuide flags */
#define OCI_SODA_DATAGUIDE_PRETTY          0x00000001         /* Pretty print */
#define OCI_SODA_DATAGUIDE_GEOJSON         0x00000002             /* GEO-JSON */
#define OCI_SODA_DATAGUIDE_GATHER_STATS    0x00000004    /* Gather statistics */
...
#define OCI_ATTR_DIRPATH_XADFIELD_RESERVED_3 2035                /* reserved */

#define OCI_ATTR_DIRPATH_RESERVED_35       2036                  /* reserved */
...
#define OCI_SODA_TIMESTAMP_MAXSIZE 32   /* max size of SODA timestamp string */
/*---------------------------------------------------------------------------*/
...
#define OCI_FNCODE_RESERVED_198           198  /* reserved OCI function code */
                                                      /* unused      199-222 */
#define OCI_FNCODE_SODACOLLTRUNCATE       223         /* OCISodaCollTruncate */
                                                          /* unused      224 */
#define OCI_FNCODE_SODAASOFSCNGET         225           /* OCISodaAsOfScnGet */
#define OCI_FNCODE_SODAASOFTIMESTAMPGET   226     /* OCISodaAsOfTimestampGet */
#define OCI_FNCODE_SODAINSGETWOPTS        227 /* OCISodaInsertAndGetWithOpts */
#define OCI_FNCODE_SODABINSGETWOPTS       228
                                          /* OCISodaBulkInsertAndGetWithOpts */
#define OCI_FNCODE_SODASAVEGETWOPTS       229   /* OCISodaSaveAndGetWithOpts */
#define OCI_FNCODE_SODADGGETWOPTS         230 /* OCISodaDataGuideGetWithOpts */
#define OCI_FNCODE_MAXFCN                 230   /* maximum OCI function code */
